                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                Edition de l'employé " {{ props.employe.nom_employe }} {{ props.employe.prenom_employe }} "
                            </h3>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <button form="formulaireModificationEmploye" type="submit" class="btn btn-success">Confirmer</button>
                        </div>
                        <div class="card-footer">
                            <Link v-if="props.employe.is_verified" :href="route('utilisateur.index')" type="button" class="btn btn-primary">Menu suivant</Link>
                        </div>
