            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form @submit.prevent="soumettre" id="formulaireNouveauEmploye">
                                ...
                                <div class="form-group">
                                    ...
                                    <span v-if="form.errors.email_employe" class="invalid-feedback error"> Ce mail a été utilisé avant, veuillez entrer un nouveau </span>
                                </div>
                        ...
                        <div class="card-footer">
                            <button form="formulaireNouveauEmploye" type="submit" class="btn btn-success">Soumettre</button>
                        </div>
                    </div>
                </div>
            </div>
...
const soumettre = ()=> {
    form.post(route("employe.store"), {
        onSuccess: (page) => {
                useSwalSuccess("Employé ajouté avec succès");
                form.reset();
                inputKey.value += 1;
